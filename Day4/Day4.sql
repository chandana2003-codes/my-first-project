...
SELECT SALARY , COUNT(*) FROM EMPLOYEES GROUP BY SALARY ORDER BY 2 DESC;
...
--FIND EMPLOYEES WHO IS HAVING THE SAME SALARY 
...
-----DATA SHOULD BE PRESENT IN BOTH EMP /DEPENDE
SELECT * FROM EMPLOYEES WHERE EMPLOYEE_ID IN (SELECT EMPLOYEE_ID FROM DEPENDENTS);

---EMPLOYEE DATA SHOULD NOT BE PRESENT IN DEPENT 
SELECT * FROM EMPLOYEES WHERE EMPLOYEE_ID NOT IN (SELECT EMPLOYEE_ID FROM DEPENDENTS);

---DATA ONLY PRESENT IN DEPENT AND NOT IN EMPLOYEE TABLE  
SELECT * FROM DEPENDENTS WHERE EMPLOYEE_ID NOT IN (SELECT EMPLOYEE_ID FROM EMPLOYEES);

SELECT * FROM EMPLOYEES;
SELECT * FROM EMPLOYEES WHERE PHONE_NUMBER = NULL; -- WRONG
SELECT * FROM EMPLOYEES WHERE PHONE_NUMBER IS NULL;
SELECT * FROM EMPLOYEES WHERE PHONE_NUMBER IS NOT NULL;

SELECT EMPLOYEE_ID, FIRST_NAME, COALESCE(PHONE_NUMBER,'NA') FROM EMPLOYEES;
SELECT EMPLOYEE_ID, FIRST_NAME, COALESCE(PHONE_NUMBER,'12345677') FROM EMPLOYEES;

SELECT COUNT(*) FROM EMPLOYEES;
SELECT COUNT(1) FROM EMPLOYEES;
SELECT COUNT(20) FROM EMPLOYEES;
SELECT COUNT(-10) FROM EMPLOYEES;
SELECT COUNT(FIRST_NAME) FROM EMPLOYEES;
SELECT COUNT(PHONE_NUMBER) FROM EMPLOYEES;

SELECT EMPLOYEE_ID, FIRST_NAME, SALARY, IFF(SALARY >= 15000 , 'Sr ' ,'Jr') AS DESIGNATION FROM EMPLOYEES;

SELECT EMPLOYEE_ID, FIRST_NAME, SALARY,
     CASE WHEN SALARY >= 15000 THEN 'Sr' ELSE 'JR' END AS DESIGNATION
FROM EMPLOYEES;
...
SELECT EMPLOYEE_ID, FIRST_NAME, SALARY, DEPARTMENT_ID,
     CASE 
         ...
         WHEN DEPARTMENT_ID = 5 THEN 'SR MANAGER'
     END AS DEPT_NAME 
FROM EMPLOYEES;
